...
Sample = 3
Sample_path = f'EM_Data/Sample_{Sample}'
## sample loop:
while os.path.exists(Sample_path):
    if Sample == 3: TS = 2
    elif Sample == 4: TS = 3
    elif Sample == 5: TS = 7
    TS_path = f'EM_Data/Sample_{Sample}/TS00{TS}'
    ## TS loop:
    while os.path.exists(TS_path):
        ...
        while os.path.exists(file_path):
            ...
            # Save the combined mesh with curvature to a VTK file
            if Neck == True:
            ...
            if Neck == False:
                file_path = f'EM_Data/Sample_{Sample}/TS00{TS}/noNeck/VLP{VLP}.stl'
